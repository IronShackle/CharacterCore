...
namespace Prespec.CharacterCore.Contracts.Actions
{
    ...
    public interface IActionModule
    {
        ...
        /// </summary>
        bool TryPlan(ActionId id, in ActionContext context, out ActionDecision decision);
        ...
        /// </summary>
        void Execute(in ActionDecision decision);
    }
    ...
    public readonly struct ActionDecision
    {
        ...
        public ActionDecision(ActionId actionId, int priority, Guid planToken)
        {
            ActionId = actionId;
            Priority = priority;
            PlanToken = planToken;
